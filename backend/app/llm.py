...
RESPONSE_TEMPLATES = {
    "short": "Give a concise, factual 2–3 line analysis grounded in the provided data.",
    "medium": "Provide a structured analysis with key takeaways and references to the provided numbers.",
    "long": "Provide a comprehensive analysis, explicitly citing indicator values and fundamentals, and outline scenario risks.",
}
